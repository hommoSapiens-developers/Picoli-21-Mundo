...
//		int historia = 0;
	...
	private void terminarPeriodo() {
		...
		capital += calculaProduccionPeriodica();
...
//		los valores sobre los periodos de calculo podrian ser definidos por el usuario
	...
	private long getProduccionPotencial() {
		return this.produccionPotencial = industria.getSizeTrabajadores()
				+ industria.getSizeParados() * getPotenciaTrabajador();
	}
...
//		siempre sebemos de saber cuales don los trabajadores que hay en cadda factoria
	...
	private long calculaProduccionPeriodica() {
		return hacienda.obtieneProduccionPeriodica();
	}
